...
<#if settings.enable_sw?? && settings.enable_sw != "false">
    <script src="${(settings.enable_sw == "uninstall")?then('${theme_base!}/source/js/sw.min.js?mew=1.0.5','/themes/dream/source/js/sw.min.js?mew=1.0.5${settings.enable_sw!}')}"></script>
</#if>
<meta charset="utf-8"/>
