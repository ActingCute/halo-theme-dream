 ...
 * @LastEditTime: 2023-01-11 11:20:53
 * @FilePath: \halo-theme-dream\source\js\photos.min.js
 * @Description: 说明
 */
(() => {
  const i = {
    initPhotos() {
      const i = $(".photos-gallery");
      let e = !1,
        c = !1;
      const n = {
        page: 0,
      ...
      const o = t => {
        ...
        (l = new Promise((a, i) => {
          ...
          console.log("finally"), i.removeClass("loading"), l = void 0, e = !1
        })).abort = s
      };
      o(), window.addEventListener("scroll", function () {
        $(window).scrollTop() + $(window).height() >= i.height() && (e || c || (n.page++, o({
          team: $(".photos-teams li.active").attr("data-team")
        })))
      }), $(".photos-teams .item").on("click", function (t) {
        t.stopPropagation();
        const a = $(this);
        a.hasClass("active") || (a.addClass("active").siblings("li").removeClass("active"), (async t => {
          l && (l.abort && l.abort("abort"), await l), i.empty(), c = !1, e = !1, n.page = 0, o(t)
        })({
          team: a.attr("data-team")
        }))
      })
    }
  };
  window.photoPjax = function (a) {
    0 !== $(".photos-gallery").length && Object.keys(i).forEach(t => window.pjaxSerialNumber === a && i[t]())
  }, window.pjaxSerialNumber || i.initPhotos()
})();